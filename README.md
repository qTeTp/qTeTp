...
### 🎯 [우상향](https://github.com/qTeTp/RUD_Project)
...
* **🍔 [배달 전문 식당 사장님들간의 소통 웹](https://github.com/qTeTp/Estsoft_Second_Project_Team_B3)**
  * 프로젝트명: BizBeacon for Boss - B3
  * 기간: 2025.09 ~ 2025.10 (완료)
  * 내용: 배달 전문 식당 사장님들간의 소통 웹 프로젝트

* **📱 [인플루언서 광고 플랫폼](https://github.com/qTeTp/hcn_spring)**
  * 프로젝트명: 협차니
  * 기간: 2024.04 ~ 2024.06 (완료)
  * 내용: 소셜 미디어 인플루언서를 통한 마케팅의 증가에 따라 광고주와 인플루언서 간의 원활한 소통을 돕는 플랫폼 프로젝트

* **🚗 [AI 블랙박스 프로젝트](https://github.com/SunMoonChul/OCR-DJANGO/tree/main)**
  * 프로젝트명: 선문철TV
  * 기간: 2023.10 ~ 2023.12 (완료)
  * 내용: 불법 주차 차량을 도로에서 색출해 번호판을 뽑아내는 ai 블랙박스 프로젝트
...
* **서비스 고도화:** 현재 개발 중인 **Stock-Keeper**의 안정적인 배포 및 운영
